    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.storefront_outlined), label: ''), // 2
          BottomNavigationBarItem(
              icon: Icon(Icons.home_outlined, size: 30), label: ''), // 3: home
          BottomNavigationBarItem(
              icon: Icon(Icons.person_outline), label: ''), // 4
          BottomNavigationBarItem(
              icon: Icon(Icons.chat_bubble_outline), label: ''), // 5
          BottomNavigationBarItem(
              icon: Icon(Icons.favorite_border), label: ''), // 6
        ],
      ),
