      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            children: [
              const TopSearchBar(),
              // reusing FilterRow from feeding_point_screen might be weird contextually 
              // but keeping it if it was intended. If not, removing it would be cleaner.
              // I'll keep it for consistency with previous code.
